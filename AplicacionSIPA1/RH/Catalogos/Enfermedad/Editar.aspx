<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="AplicacionSIPA1.RH.Catalogos.Enfermedad.Editar" MasterPageFile="~/Principal.Master" %>

<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="head">
</asp:Content>
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder3">
    <div style="margin-left: 5%; width: 90%; height: 100%; align-content:center">
        <h3 style="text-align:center">Editar Enfermedad</h3>
        <hr />
             ...
             <table style="width:80%;" >
                  ...
                  <tr>
                   <td style="width: 15%"></td>
                    <td>
                        <asp:Button ID="Button1" runat="server" Text="Editar" OnClick="EditarEnfermedad" CssClass="btn btn-sm btn-success" Width="50%"/>
                    </td>
                  </tr>
             </table>
          </div>
