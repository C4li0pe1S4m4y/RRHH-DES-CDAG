<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Eliminar.aspx.cs" Inherits="AplicacionSIPA1.RH.Catalogos.Departamento.Eliminar" MasterPageFile="~/Principal.Master" %>

<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="head">
</asp:Content>
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder3">
    <div style="margin-left: 5%; width: 90%; height: 100%; align-content:center">
        <h3 style="text-align:center">Eliminar Departamento</h3>
        <hr />
            ...
            <table style="width:80%;" >
                  ...
                  <tr>
                   <td style="width: 15%"></td>
                    <td>
                        <asp:Button ID="Button1" runat="server" Text="Eliminar" OnClick="EliminarDepartamento" CssClass="btn btn-sm btn-danger"/>
                    </td>
                  </tr>
             </table>
        </div>
