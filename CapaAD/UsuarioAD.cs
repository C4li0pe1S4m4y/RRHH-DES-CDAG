   ...
   public class UsuarioAD
    {
       ...
       public DataTable usuarioRRHH(string idusr)
       {
           conectar = new ConexionBD();
           DataTable tabla = new DataTable();
           conectar.AbrirConexion();
           MySqlDataAdapter consulta = new MySqlDataAdapter("select usuario from ccl_usuarios_rrhh where usuario = '" + idusr + "';", conectar.conectar);
           consulta.Fill(tabla);
        ...
        public DataTable dropUnidad()
       {
        ...
        public DataTable DatosEmpleadoByUsuario(String User)
        {
            conectar = new ConexionBD();
            DataTable tabla = new DataTable();
            conectar.AbrirConexion();
            MySqlDataAdapter consulta = new MySqlDataAdapter("CALL slctDatosEmpleadoByUser('" + User + "');", conectar.conectar);
            consulta.Fill(tabla);
            conectar.CerrarConexion();
            return tabla;
        }
       ...
       public DataTable ObtenerMenus(int idMenu)
       {
        ...
        /*public DataTable dropEmpleadoUsuario()
        {
         ...
         public DataTable datosUsuario(String sUser)
        {
            conectar = new ConexionBD();
            DataTable tabla = new DataTable();
            conectar.AbrirConexion();
            MySqlDataAdapter consulta = new MySqlDataAdapter("call slctUsuarios2('" + sUser + "');", conectar.conectar);
            consulta.Fill(tabla);
            conectar.CerrarConexion();
            return tabla;
        }
